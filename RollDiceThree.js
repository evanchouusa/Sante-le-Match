	...
	<div className='RollDice'>
        ...
        <div style={{textAlign: 'center'}}>
            ...
            <h3>
                ...
                {this.state.finished ? "You finished Lesson 3!" : ""}
            </h3>
            <p>
                {this.state.finished ? "Please study Lesson 4" : ""}
            </p>
        </div>
        
        <div style={{padding, left, top, position: 'absolute'}}>
        {this.state.clickMe ? (<Link to={{ screen: 'QuestionsThree', params: {passStep: this.steps, backStep: this.backStep} }} > <img src={character} style={{width: 100, float: 'right'}}/> </Link>) : (<img src={character} style={{width: 100, float: 'right'}}/>)}
        </div>
	</div>
	)
}
