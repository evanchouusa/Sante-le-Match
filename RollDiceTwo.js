	...
	<div className='RollDice'>
        ...
        <div style={{textAlign: 'center'}}>
            ...
            <h3>
                ...
                {this.state.finished ? "You finished Lesson 2!" : ""}
            </h3>
            <p>
                {this.state.finished ? "Please study Lesson 3" : ""}
            </p>
        </div>
        
        <div style={{padding, left, top, position: 'absolute'}}>
        {this.state.clickMe ? (<Link to={{ screen: 'QuestionsTwo', params: {passStep: this.steps, backStep: this.backStep} }} > <img src={character} style={{width: 100, float: 'right'}}/> </Link>) : (<img src={character} style={{width: 100, float: 'right'}}/>)}
        </div>
	</div>
	)
}
